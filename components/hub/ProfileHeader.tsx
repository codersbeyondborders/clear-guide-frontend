        ...
        <div className="px-5 pb-5">
          ...
          <div className="flex items-center gap-5">
            ...
            <button
              ...
              className="text-center hover:opacity-80 transition-opacity focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded-lg px-2 py-0.5">
              <p className="text-base font-bold" style={{ color: 'var(--color-foreground)' }}>{profile.followerCount}</p>
              <p className="text-xs hover:underline" style={{ color: 'var(--color-muted-foreground)' }}>Followers</p>
            </button>
            <button
              type="button"
              ...
              <p className="text-xs hover:underline" style={{ color: 'var(--color-muted-foreground)' }}>Following</p>
            </button>
          </div>
        </div>
      </header>
